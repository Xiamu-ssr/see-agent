...
use agentcorp::agent::{create_agent, delete_agent, list_agents, load_agent};
use agentcorp::types::{Message, MessagePriority};
...
fn parse_identity(ws: &agentcorp::types::WorkspaceDir, agent_id: &str) -> (String, String) {
    let agent_dir = ws.agent(agent_id);
