...
use see::agent::{create_agent, delete_agent, list_agents, load_agent};
use see::types::{Message, MessagePriority};
...
fn parse_identity(ws: &see::types::WorkspaceDir, agent_id: &str) -> (String, String) {
    let agent_dir = ws.agent(agent_id);
