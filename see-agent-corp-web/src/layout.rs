...
pub fn AppLayout(is_dark: RwSignal<bool>, children: Children) -> impl IntoView {
    ...
    let active_nav = move |path: &'static str| {
        let current = location.pathname.get();
        let segment = current.split('/').nth(1).unwrap_or("");
        let target = path.trim_start_matches('/');
        let is_active = if target.is_empty() {
            segment.is_empty()
        } else {
            segment == target
        };
                ...
                <div class="navbar bg-base-300 lg:hidden">
                    ...
                    <div class="flex-none">
                        <label class="swap swap-rotate">
                            ...
                            />
                            <svg class="swap-on h-5 w-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21.64,13a1,1,0,0,0-1.05-.14,8.05,8.05,0,0,1-3.37.73A8.15,8.15,0,0,1,9.08,5.49a8.59,8.59,0,0,1,.25-2A1,1,0,0,0,8,2.36,10.14,10.14,0,1,0,22,14.05,1,1,0,0,0,21.64,13Z"></path></svg>
            ...
            <div class="drawer-side z-40">
                ...
                <aside class="bg-base-200 min-h-full w-64 flex flex-col">
                    ...
                    <ul class="menu p-4 gap-1 flex-1">
                        <li><A href="/" attr:class=move || active_nav("/")>
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg>
                            "Dashboard"
                        </A></li>
                        <li><A href="/agents" attr:class=move || active_nav("/agents")>
                        ...
                        <li><A href="/teams" attr:class=move || active_nav("/teams")>
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
                            "Teams"
                        </A></li>
                        <li><A href="/config" attr:class=move || active_nav("/config")>
                        ...
                        <li><A href="/skills" attr:class=move || active_nav("/skills")>
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                            "Skills"
                        </A></li>
                        <li><A href="/tools" attr:class=move || active_nav("/tools")>
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.066 2.573c1.756.426 1.756 2.924 0 3.35" /></svg>
                            "Tools"
                        </A></li>
                        <li><A href="/mcp" attr:class=move || active_nav("/mcp")>
                        ...
                        <li><A href="/logs" attr:class=move || active_nav("/logs")>
