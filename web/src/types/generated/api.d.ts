...
export interface paths {
    ...
    "/api/chat": {
        ...
        /**
         * Chat
         * @description Accept a task and run the agent loop in the background.
         *
         *     Parameters:
    ...
    "/api/chat/{task_id}/message": {
        ...
        /**
         * Inject Message
         * @description Inject a user message into a running task's queue.
         */
        post: operations["inject_message_api_chat__task_id__message_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/sessions/{session_id}/screenshot/{step}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Get Screenshot
         * @description Serve a session screenshot as a WebP file.
         */
        get: operations["get_screenshot_api_sessions__session_id__screenshot__step__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        /**
         * ChatRequest
         * @description Request body for POST /api/chat.
         */
        ChatRequest: {
            /** Task */
            task: string;
        ...
        /**
         * ChatResponse
         * @description Response body for POST /api/chat.
         */
        ChatResponse: {
            /** Task Id */
            task_id: string;
        ...
        /**
         * TaskStatus
         * @description Represents the current status of a running or completed task.
         */
        TaskStatus: {
            /** Task Id */
            task_id: string;
        ...
        /**
         * UserMessageRequest
         * @description Request body for POST /api/chat/{task_id}/message.
         */
        UserMessageRequest: {
            /** Message */
            message: string;
...
export interface operations {
    ...
    inject_message_api_chat__task_id__message_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    get_screenshot_api_sessions__session_id__screenshot__step__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
